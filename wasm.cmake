...
set (CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -fexceptions -s DISABLE_EXCEPTION_CATCHING=0 -s USE_PTHREADS=1" CACHE STRING "")
...
set (CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fexceptions -s DISABLE_EXCEPTION_CATCHING=0 -s USE_PTHREADS=1" CACHE STRING "")
...
set (CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -Wl,--shared-memory,--no-check-features --bind -s NO_EXIT_RUNTIME=1" CACHE STRING "Emscripten-overridden CMAKE_EXE_LINKER_FLAGS")
set (CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} --bind -s NO_EXIT_RUNTIME=1" CACHE STRING "Emscripten-overridden")
...
set (CMAKE_BUILD_WITH_INSTALL_RPATH ON CACHE BOOL "Force CMAKE_BUILD_WITH_INSTALL_RPATH" FORCE )
