...
set(CMAKE_C_FLAGS_RELEASE "-DNDEBUG -O2 -s WASM=0 " CACHE STRING "Emscripten-overridden CMAKE_C_FLAGS_RELEASE")
...
set (CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -fexceptions -s DISABLE_EXCEPTION_CATCHING=0 -s USE_PTHREADS=0" CACHE STRING "")
...
set (CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} --bind -fexceptions -s DISABLE_EXCEPTION_CATCHING=0 -s USE_PTHREADS=0 -s WASM=0 " CACHE STRING "")

set(CMAKE_EXE_LINKER_FLAGS "-Wl,--no-check-features -s USE_PTHREADS=0 -s WASM=0 " CACHE STRING "Emscripten-overridden CMAKE_EXE_LINKER_FLAGS")
...
set (CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -Wl,--no-check-features --bind -s NO_EXIT_RUNTIME=1 " CACHE STRING "Emscripten-overridden CMAKE_EXE_LINKER_FLAGS")
set (CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} --bind -s NO_EXIT_RUNTIME=1 -s USE_PTHREADS=0 -s WASM=0 " CACHE STRING "Emscripten-overridden")
