...
RUN curl -fsSL https://raw.githubusercontent.com/tipi-build/cli/3b7886d33073bbc8800fc4f8963a9505c18eff7e/install/container/centos.sh -o centos.sh && /bin/bash centos.sh
