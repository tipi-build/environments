...
RUN cmake -G Ninja -S llvm -B build/musl \
  ...
  -DRUNTIMES_${TARGET_TRIPLE}_LIBCXX_ADDITIONAL_COMPILE_FLAGS="-I${SYSROOT_PATH}/include;-I${SYSROOT_PATH}/include/${TARGET_TRIPLE}" \
  -DRUNTIMES_${TARGET_TRIPLE}_LIBCXXABI_ADDITIONAL_COMPILE_FLAGS="-I${SYSROOT_PATH}/include;-I${SYSROOT_PATH}/include/${TARGET_TRIPLE}" \
  -DRUNTIMES_${TARGET_TRIPLE}_LIBUNWIND_ADDITIONAL_COMPILE_FLAGS="-I${SYSROOT_PATH}/include;-I${SYSROOT_PATH}/include/${TARGET_TRIPLE}" \
